import { DomUtils, parseDocument } from 'https://esm.sh/htmlparser2@7.2.0';
import { Document, Element, isTag, Node } from 'https://esm.sh/domhandler@4.3.0';
import render from 'https://esm.sh/dom-serializer@1.3.2';
...
function do_templating(
    ...
    while (true) {
        ...
        let fills_arr = DomUtils.getChildren(use_el).filter((c) =>
            isTag(c) && c.tagName == 'mx-fill'
        ) as Element[];
